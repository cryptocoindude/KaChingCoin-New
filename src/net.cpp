...
static const char *strDNSSeed[][2] = {
    {"node1.KaChingCoin.info", "node1.KaChingCoin.info"},
    {"node2.KaChingCoin.info", "node2.KaChingCoin.info"},
    {"node3.KaChingCoin.info", "node3.KaChingCoin.info"},
    {"node4.KaChingCoin.info", "node4.KaChingCoin.info"},
};
